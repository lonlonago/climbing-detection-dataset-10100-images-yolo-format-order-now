# Climbing detection dataset 10100 images Yolo format order now.

# Body

Climbing detection dataset, 10100 images in Yolo format， or change
Ideal for target detection, model training, research.

Annotation
Category Number of images Number of annotations
no_clim 3,756 4,384
climb 8,000 8,010
